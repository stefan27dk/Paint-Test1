...
namespace GUI.GUI__Visual___Classes
{
    class Resizable_Panel
    {


        // Constructor
        public Resizable_Panel()
        {
        ...
        public Panel Get_Right_Tool_Panel()
        {
            ...
            Right_Tool_Panel.Resize += new System.EventHandler(this.Right_Tool_Panel_Resize); // Size_Changed    //# Used For Refreshing the Border so it does not flickers
